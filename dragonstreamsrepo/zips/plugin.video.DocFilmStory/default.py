# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/DocFilmStory
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "DocFilmStory"

# Entry point
def run():
    plugintools.log("DocFilmStory.run")
...
def main_list(params):
    plugintools.log("DocFilmStory.main_list "+repr(params))
    ...
    plugintools.add_item( action="main_list" , title="[COLOR=FF00FF00]##### Next Page #####[/COLOR]" , url=next_page_url , folder=True )
